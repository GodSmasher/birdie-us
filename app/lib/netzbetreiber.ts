...
const RULES: Rule[] = [
  ...
  { match: startsWith('06', '38', '39'), nb: { name: 'Avacon Netz', portalUrl: 'https://www.avacon-netz.de/de/einspeisung.html', confidence: 'wahrscheinlich' } },
  // Thüringen
  ...
  { match: startsWith('15', '16', '17', '18', '19'), nb: { name: 'E.DIS Netz', portalUrl: 'https://www.e-dis-netz.de/de/einspeiser.html', confidence: 'wahrscheinlich' } },
  ...
  // Niedersachsen Mitte
  { match: startsWith('29', '30', '31', '37'), nb: { name: 'Avacon Netz', portalUrl: 'https://www.avacon-netz.de/de/einspeisung.html', confidence: 'pruefen' } },
  ...
  // Bayern (Bayernwerk Netz – größter Flächen-DSO Bayern)
  { match: startsWith('82', '83', '84', '85', '90', '91', '92', '93', '94', '95', '96'), nb: { name: 'Bayernwerk Netz', portalUrl: 'https://www.bayernwerk-netz.de/de/energie-einspeisen.html', confidence: 'wahrscheinlich' } },
  ...
  // Unterfranken
  { match: startsWith('97'), nb: { name: 'Bayernwerk Netz', portalUrl: 'https://www.bayernwerk-netz.de/de/energie-einspeisen.html', confidence: 'pruefen' } },
];
