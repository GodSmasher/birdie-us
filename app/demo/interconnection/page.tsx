...
export const metadata = { title: 'birdie — Interconnection Demo (Oncor)' };
...
const PROJECTS: Project[] = [
  {
    id: 'P-1001', customer: 'Rivera Family', address: '782 Oak Hill Dr', city: 'Plano', state: 'TX', zip: '75023',
    utility: 'Oncor', systemKw: 11.2, modules: 'REC Alpha Pure-R 400W x28', inverter: 'Enphase IQ8M-72',
    stage: 'signed', applicationId: 'ONC-2026-44182', meterNumber: 'MTR-882441', permitNumber: 'PL-2026-3318',
    necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 28500, dueDate: '2026-06-27',
    notes: 'Signed docs need upload to Oncor portal before Jun 27',
  },
  {
    id: 'P-1002', customer: 'Martinez Residence', address: '4521 Elm Creek Blvd', city: 'Dallas', state: 'TX', zip: '75240',
    utility: 'Oncor', systemKw: 8.8, modules: 'Q CELLS Q.PEAK DUO ML-G11S 440W x20', inverter: 'SolarEdge SE7600H',
    stage: 'review', applicationId: 'ONC-2026-44290', permitNumber: 'PL-2026-4412',
    necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 22100,
    notes: 'City of Plano permit pending since Jun 18',
  },
  {
    id: 'P-1003', customer: 'Thompson Solar', address: '1190 Sunset Ridge', city: 'McKinney', state: 'TX', zip: '75071',
    utility: 'Oncor', systemKw: 14.4, modules: 'Canadian Solar HiKu7 CS7L-600MS x24', inverter: 'SMA Sunny Boy 7.7',
    stage: 'approved', applicationId: 'ONC-2026-43891', meterNumber: 'MTR-771092', permitNumber: 'PL-2026-2987',
    inspectionDate: '2026-06-27', necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 35200,
    notes: 'Oncor approved — meter swap scheduled Jun 27',
  },
  {
    id: 'P-1004', customer: 'Chen Family', address: '305 Pecan Valley Ct', city: 'Frisco', state: 'TX', zip: '75034',
    utility: 'Oncor', systemKw: 9.6, modules: 'Silfab SIL-420-BG x24', inverter: 'Enphase IQ8A-72',
    stage: 'submitted', applicationId: 'ONC-2026-44501', meterNumber: 'MTR-993210', permitNumber: 'PL-2026-4718',
    necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 24800,
  },
  {
    id: 'P-1005', customer: 'Williams Residence', address: '8812 Bluebonnet Ln', city: 'Allen', state: 'TX', zip: '75002',
    utility: 'Oncor', systemKw: 7.2, modules: 'LONGi Hi-MO 6 555W x13', inverter: 'Enphase IQ8M-72',
    stage: 'open', necCompliant: false, ieeeCompliant: false, iraEligible: true, value: 18500,
    notes: 'Awaiting site survey completion',
  },
  {
    id: 'P-1006', customer: 'Patel Solar Project', address: '2200 Coit Rd', city: 'Richardson', state: 'TX', zip: '75080',
    utility: 'Oncor', systemKw: 12.0, modules: 'Trina Vertex S+ TSM-445NEG9R.28 x27', inverter: 'SolarEdge SE10000H',
    stage: 'submitted', applicationId: 'ONC-2026-43650', meterNumber: 'MTR-550318',
    necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 31000,
  },
  {
    id: 'P-1007', customer: 'Davis Home', address: '4100 Legacy Dr', city: 'Plano', state: 'TX', zip: '75024',
    utility: 'Oncor', systemKw: 6.4, modules: 'REC Alpha Pure-R 400W x16', inverter: 'Enphase IQ8A-72',
    stage: 'review', applicationId: 'ONC-2026-44622',
    necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 16200,
  },
  {
    id: 'P-1008', customer: 'Johnson Family', address: '955 Preston Oaks', city: 'Dallas', state: 'TX', zip: '75230',
    utility: 'Oncor', systemKw: 10.8, modules: 'Canadian Solar HiKu7 CS7L-600MS x18', inverter: 'SMA Sunny Boy 10.0',
    stage: 'complete', applicationId: 'ONC-2026-42100', meterNumber: 'MTR-441287',
    necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 27500,
  },
  {
    id: 'P-1009', customer: 'Garcia Residence', address: '7730 Spring Valley', city: 'Richardson', state: 'TX', zip: '75081',
    utility: 'Oncor', systemKw: 8.0, modules: 'Q CELLS Q.PEAK DUO ML-G11S 440W x18', inverter: 'Enphase IQ8M-72',
    stage: 'open', necCompliant: false, ieeeCompliant: false, iraEligible: true, value: 20100,
  },
  {
    id: 'P-1010', customer: 'Anderson Solar', address: '3320 Waterview Pkwy', city: 'Allen', state: 'TX', zip: '75013',
    utility: 'Oncor', systemKw: 15.6, modules: 'LONGi Hi-MO 6 555W x28', inverter: 'SolarEdge SE11400H',
    stage: 'submitted', applicationId: 'ONC-2026-44100', meterNumber: 'MTR-667482',
    necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 38900,
  },
  {
    id: 'P-1011', customer: 'Kim Residence', address: '1450 Independence Pkwy', city: 'Plano', state: 'TX', zip: '75075',
    utility: 'Oncor', systemKw: 9.2, modules: 'Silfab SIL-420-BG x22', inverter: 'Enphase IQ8A-72',
    stage: 'approved', applicationId: 'ONC-2026-44320', meterNumber: 'MTR-882190',
    necCompliant: true, ieeeCompliant: true, iraEligible: true, value: 23400,
  },
  {
    id: 'P-1012', customer: 'Nelson Home', address: '6200 Communications Pkwy', city: 'Plano', state: 'TX', zip: '75024',
    utility: 'Oncor', systemKw: 5.6, modules: 'REC Alpha Pure-R 400W x14', inverter: 'Enphase IQ8M-72',
    ...
    <>
      ...
      <main className="flex-1 min-w-0 flex flex-col bg-bg">
        <TopBar
          ...
          subtitle="Oncor Electric Delivery · DFW Metro · NEC 690 / IEEE 1547 / IRA §48"
        />
        <div className="flex-1 px-6 py-5 flex flex-col gap-4 overflow-auto">
          ...
          <div className="grid grid-cols-5 gap-3 shrink-0">
            ...
            <KpiCard label="SUBMITTED" value={String(submitted)} sub="to Oncor" valueColor="text-success" />
