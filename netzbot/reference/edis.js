/**
 * E.Dis Netz GmbH (Brandenburg / Mecklenburg-Vorpommern) — Portal-Filler
 * Portal: https://www.e-dis-netz.de/de/meinauftragsportal.html
 * Plattform: SFDC Installateurportal (EON-Gruppe, identisch mit Bayernwerk)
 */

const { fillEonGroup } = require('./_eon-group');

const PORTAL_URL = 'https://www.e-dis-netz.de/de/meinauftragsportal.html';
