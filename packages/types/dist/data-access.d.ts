import type { CompanyRow, CompanyInsert, CompanyUpdate, CompanyBrandingRow, ProfileRow, ProfileInsert, ProfileUpdate, RoleRow, LeadRow, LeadInsert, LeadUpdate, OfferRow, OfferInsert, OfferUpdate, CallRow, CallAnalysisRow, ProjectRow, ProjectInsert, ProjectUpdate, InvoiceRow, InvoiceInsert, InvoiceUpdate, KpiSnapshotRow, TeamMemberRow, ConnectorRow, PhaseDefinitionRow } from './database.js';
...
export interface LeadsRepository {
    findMany(companyId: string, opts?: {
        status?: string;
        setterId?: string;
    }): Promise<LeadRow[]>;
    findPaginated(companyId: string, opts?: {
        status?: string;
        setterId?: string;
    } & PaginationOpts): Promise<PaginatedResult<LeadRow>>;
    count(companyId: string, opts?: {
        status?: string;
    }): Promise<number>;
...
export interface OffersRepository {
    ...
    findPaginated(companyId: string, opts?: {
        ...
        beraterId?: string;
        minAmountChf?: number;
    } & PaginationOpts): Promise<PaginatedResult<OfferRow>>;
    count(companyId: string, opts?: {
        status?: string;
    }): Promise<number>;
    sumAmountChf(companyId: string, opts?: {
