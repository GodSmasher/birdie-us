...
exports.kpiSnapshots = exports.connectors = exports.invoices = exports.projects = exports.phaseDefinitions = exports.callAnalyses = exports.calls = exports.offers = exports.leads = exports.teamMembers = exports.profileRoles = exports.profiles = exports.rolePermissions = exports.permissions = exports.roles = exports.tenantBrandings = exports.tenants = exports.HOLDING_ADMIN_PROFILE_ID = exports.TENANT_TEST_COMPANY_ID = exports.TENANT_ALPEN_ENERGIE_ID = exports.DEFAULT_HOLDING_ID = void 0;
// ---------------------------------------------------------------------------
// Constants — Tenant IDs
// ---------------------------------------------------------------------------
exports.DEFAULT_HOLDING_ID = '00000000-0000-0000-0000-000000000010';
exports.TENANT_ALPEN_ENERGIE_ID = '00000000-0000-0000-0000-000000000001';
exports.TENANT_TEST_COMPANY_ID = '00000000-0000-0000-0000-000000000002';
// ---------------------------------------------------------------------------
// Constants — Holding Admin Profile ID
// ---------------------------------------------------------------------------
exports.HOLDING_ADMIN_PROFILE_ID = 'h0000000-0000-0000-0000-000000000001';
// ---------------------------------------------------------------------------
// Helper — deterministic UUID generator for seed data
// ---------------------------------------------------------------------------
function profileId(tenantNum, roleIndex) {
...
function roleId(tenantNum, roleIndex) {
    const tn = String(tenantNum).padStart(2, '0');
    const ri = String(roleIndex).padStart(2, '0');
    return `r${tn}00000-0000-0000-0000-0000000000${ri}`;
}
function permId(index) {
...
exports.tenants = [
    {
        id: exports.TENANT_ALPEN_ENERGIE_ID,
        holding_id: exports.DEFAULT_HOLDING_ID,
        slug: 'muster-solar',
        name: 'Muster Solar GmbH',
        status: 'active',
        created_by: exports.HOLDING_ADMIN_PROFILE_ID,
        created_at: '2026-01-15T08:00:00.000Z',
        updated_at: '2026-01-15T08:00:00.000Z',
    },
    {
        id: exports.TENANT_TEST_COMPANY_ID,
        holding_id: exports.DEFAULT_HOLDING_ID,
        slug: 'test-company',
...
// TENANT BRANDINGS
// ---------------------------------------------------------------------------
exports.tenantBrandings = [
    {
        id: brandingId(1),
        company_id: exports.TENANT_ALPEN_ENERGIE_ID,
        holding_id: exports.DEFAULT_HOLDING_ID,
    ...
    {
        id: brandingId(2),
        company_id: exports.TENANT_TEST_COMPANY_ID,
        holding_id: exports.DEFAULT_HOLDING_ID,
...
exports.permissions = permissionDefs.map((pd, i) => ({
    id: permId(i + 1),
    key: pd.key,
    label: pd.label,
...
// ---------------------------------------------------------------------------
function getPermId(key) {
    const perm = exports.permissions.find((p) => p.key === key);
    if (!perm)
...
let rpCounter = 0;
function buildRolePermissions(targetRoles) {
    const result = [];
...
exports.rolePermissions = buildRolePermissions(exports.roles);
// ---------------------------------------------------------------------------
// PROFILES
// ---------------------------------------------------------------------------
// Tenant 1 profile names (alpen-energie)
const t1Names = [
    { first: 'Thomas', last: 'Brunner', email: 'thomas.brunner@muster-solar.ch', phone: '+41 79 100 0001', roleKey: 'super_user' },
    { first: 'Hans', last: 'M\u00fcller', email: 'hans.mueller@muster-solar.ch', phone: '+41 79 100 0002', roleKey: 'geschaeftsfuehrung' },
    { first: 'Petra', last: 'Schneider', email: 'petra.schneider@muster-solar.ch', phone: '+41 79 100 0003', roleKey: 'teamleiter' },
    { first: 'Marco', last: 'Bernasconi', email: 'marco.bernasconi@muster-solar.ch', phone: '+41 79 100 0004', roleKey: 'setter' },
    { first: 'Sarah', last: 'Keller', email: 'sarah.keller@muster-solar.ch', phone: '+41 79 100 0005', roleKey: 'berater' },
    { first: 'Ursula', last: 'Widmer', email: 'ursula.widmer@muster-solar.ch', phone: '+41 79 100 0006', roleKey: 'innendienst' },
    { first: 'Beat', last: 'Zimmermann', email: 'beat.zimmermann@muster-solar.ch', phone: '+41 79 100 0007', roleKey: 'bau' },
    { first: 'Claudia', last: 'Meier', email: 'claudia.meier@muster-solar.ch', phone: '+41 79 100 0008', roleKey: 'buchhaltung' },
    { first: 'Lukas', last: 'Steiner', email: 'lukas.steiner@muster-solar.ch', phone: '+41 79 100 0009', roleKey: 'leadkontrolle' },
];
...
function buildProfiles(companyId, tenantNum, names) {
...
exports.profiles = [
    ...
    {
        id: exports.HOLDING_ADMIN_PROFILE_ID,
        company_id: null,
        holding_id: null,
        first_name: 'Stefan',
        last_name: 'Enura',
    ...
    ...buildProfiles(exports.TENANT_ALPEN_ENERGIE_ID, 1, t1Names),
    // Tenant 2 (test-company)
    ...buildProfiles(exports.TENANT_TEST_COMPANY_ID, 2, t2Names),
];
// ---------------------------------------------------------------------------
// PROFILE → ROLE MAPPING
// ---------------------------------------------------------------------------
let prCounter = 0;
function buildProfileRoles() {
    const result = [];
    // Holding admin
    prCounter++;
    result.push({
        id: prId(prCounter),
        profile_id: exports.HOLDING_ADMIN_PROFILE_ID,
...
exports.profileRoles = buildProfileRoles();
// ---------------------------------------------------------------------------
...
exports.teamMembers = [
    // Setters
    {
        ...
        email: 'marco.bernasconi@muster-solar.ch',
    ...
    },
    {
        ...
        email: 'fabio.rossi@muster-solar.ch',
    ...
    },
    {
        ...
        email: 'anja.lehmann@muster-solar.ch',
    ...
    // Beraters
    {
        ...
        email: 'sarah.keller@muster-solar.ch',
    ...
    },
    {
        ...
        email: 'david.mueller@muster-solar.ch',
    ...
    },
    {
        ...
        email: 'laura.ammann@muster-solar.ch',
...
exports.leads = leadData.map((ld, i) => ({
    id: leadId(i + 1),
    company_id: exports.TENANT_ALPEN_ENERGIE_ID,
    holding_id: exports.DEFAULT_HOLDING_ID,
...
exports.offers = offerData.map((od, i) => ({
    id: offerId(i + 1),
    company_id: exports.TENANT_ALPEN_ENERGIE_ID,
    holding_id: exports.DEFAULT_HOLDING_ID,
...
exports.calls = Array.from({ length: 30 }, (_, i) => {
    ...
    return {
        ...
        status: callStatuses[i] ?? 'answered',
        ...
        recording_url: duration > 0 ? `https://storage.muster-solar.ch/recordings/call-${String(i + 1).padStart(4, '0')}.mp3` : null,
...
// ---------------------------------------------------------------------------
exports.callAnalyses = exports.calls
...
exports.phaseDefinitions = phaseNames.map((pn, i) => ({
    id: phaseDefId(i + 1),
    company_id: exports.TENANT_ALPEN_ENERGIE_ID,
    holding_id: exports.DEFAULT_HOLDING_ID,
    phase_number: i + 1,
...
exports.projects = projectData.map((pd, i) => ({
    id: projectId(i + 1),
    company_id: exports.TENANT_ALPEN_ENERGIE_ID,
    holding_id: exports.DEFAULT_HOLDING_ID,
...
exports.invoices = invoiceData.map((inv, i) => ({
    id: invoiceId(i + 1),
    company_id: exports.TENANT_ALPEN_ENERGIE_ID,
    holding_id: exports.DEFAULT_HOLDING_ID,
