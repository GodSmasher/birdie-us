...
export type LeadStatus = 'new' | 'contacted' | 'qualified' | 'appointment_set' | 'won' | 'lost' | 'invalid';
export type LeadSource = 'website' | 'referral' | 'partner' | 'advertising' | 'cold_call' | 'leadnotes' | 'other';
export type OfferStatus = 'draft' | 'sent' | 'negotiating' | 'won' | 'lost' | 'expired';
...
export type ConnectorType = 'reonic' | '3cx' | 'bexio' | 'google_calendar' | 'leadnotes' | 'whatsapp' | 'gmail' | 'crm' | 'telephony' | 'accounting' | 'calendar' | 'leads';
...
export type ComplianceRuleTriggerEvent = 'connector_created' | 'company_created' | 'holding_created' | 'document_uploaded' | 'secret_rotated' | 'manual' | 'scheduled';
...
export type ComplianceDocumentType = 'avv' | 'dpa' | 'dsfa' | 'tom' | 'certificate' | 'audit_report' | 'vvt' | 'consent_form' | 'other';
...
export type BankChangeRequestStatus = 'pending_review' | 'reviewed' | 'approved' | 'rejected' | 'cancelled';
export type BankChangeSource = 'internal' | 'supplier_request' | 'invoice_mismatch';
...
export type BankChangeLogAction = 'created' | 'reviewed' | 'approved' | 'rejected' | 'cancelled' | 'activated' | 'evidence_uploaded';
...
export type FinanzplanungInvoiceStatus = 'received' | 'extraction_done' | 'match_review' | 'in_validation' | 'returned_formal' | 'formally_approved' | 'pending_approval' | 'returned_internal' | 'returned_sender' | 'approved' | 'scheduled' | 'in_payment_run' | 'paid';
...
export type PaymentRunStatus = 'draft' | 'submitted' | 'under_review' | 'approved' | 'rejected' | 'exported' | 'confirmed_paid';
    ...
    public: {
        Tables: {
            ...
            domain_mappings: {
                ...
                Insert: DomainMappingInsert;
                Update: DomainMappingUpdate;
                Relationships: [];
            };
            holding_admins_v2: {
                Row: HoldingAdminV2Row;
                Insert: HoldingAdminV2Insert;
                Update: HoldingAdminV2Update;
                Relationships: [];
            };
            enura_admins: {
                Row: EnuraAdminRow;
                Insert: EnuraAdminInsert;
                Update: EnuraAdminUpdate;
                Relationships: [];
            };
            company_branding: {
                Row: CompanyBrandingRow;
                Insert: CompanyBrandingInsert;
            ...
            profile_roles: {
                Row: ProfileRoleRow;
                Insert: ProfileRoleInsert;
                Update: ProfileRoleUpdate;
                Relationships: [];
            };
            team_members: {
                Row: TeamMemberRow;
            ...
            phase_definitions: {
                ...
                Insert: PhaseDefinitionInsert;
                Update: PhaseDefinitionUpdate;
                Relationships: [];
            };
            projects: {
                Row: ProjectRow;
            ...
            connector_sync_log: {
                Row: ConnectorSyncLogRow;
                Insert: ConnectorSyncLogInsert;
                Update: ConnectorSyncLogUpdate;
                Relationships: [];
            };
            kpi_snapshots: {
                Row: KpiSnapshotRow;
                Insert: KpiSnapshotInsert;
                Update: KpiSnapshotUpdate;
                Relationships: [];
            };
            cashflow_entries: {
                Row: CashflowEntryRow;
                Insert: CashflowEntryInsert;
                Update: CashflowEntryUpdate;
                Relationships: [];
            };
            calendar_events: {
            ...
            holding_admins: {
                Row: HoldingAdminRow;
                Insert: HoldingAdminInsert;
                Update: HoldingAdminUpdate;
                Relationships: [];
            };
            payments: {
                Row: PaymentRow;
            ...
            offer_notes: {
                Row: OfferNoteRow;
                Insert: OfferNoteInsert;
                Update: OfferNoteUpdate;
                Relationships: [];
            };
            call_scripts: {
                Row: CallScriptRow;
                Insert: CallScriptInsert;
                Update: CallScriptUpdate;
                Relationships: [];
            };
            cashflow_uploads: {
                Row: CashflowUploadRow;
                Insert: CashflowUploadInsert;
                Update: CashflowUploadUpdate;
                Relationships: [];
            };
            project_phase_history: {
                Row: ProjectPhaseHistoryRow;
                Insert: ProjectPhaseHistoryInsert;
                Update: ProjectPhaseHistoryUpdate;
                Relationships: [];
            };
            daily_reports: {
                Row: DailyReportRow;
            ...
            email_activity: {
                ...
                Insert: EmailActivityInsert;
                Update: EmailActivityUpdate;
                Relationships: [];
            };
            holding_secrets: {
                Row: HoldingSecretRow;
                Insert: HoldingSecretInsert;
                Update: HoldingSecretUpdate;
                Relationships: [];
            };
            tool_registry: {
                Row: ToolRegistryRow;
                Insert: ToolRegistryInsert;
                Update: ToolRegistryUpdate;
                Relationships: [];
            };
            process_templates: {
                Row: ProcessTemplateRow;
                Insert: ProcessTemplateInsert;
                Update: ProcessTemplateUpdate;
                Relationships: [];
            };
            process_definitions: {
                Row: ProcessDefinitionRow;
                Insert: ProcessDefinitionInsert;
            ...
            process_step_sources: {
                Row: ProcessStepSourceRow;
                Insert: ProcessStepSourceInsert;
                Update: ProcessStepSourceUpdate;
                Relationships: [];
            };
            process_step_interfaces: {
                Row: ProcessStepInterfaceRow;
                Insert: ProcessStepInterfaceInsert;
                Update: ProcessStepInterfaceUpdate;
                Relationships: [];
            };
            process_step_liquidity: {
                Row: ProcessStepLiquidityRow;
                Insert: ProcessStepLiquidityInsert;
                Update: ProcessStepLiquidityUpdate;
                Relationships: [];
            };
            process_versions: {
                Row: ProcessVersionRow;
                Insert: ProcessVersionInsert;
                Update: ProcessVersionUpdate;
                Relationships: [];
            };
            process_deployments: {
                Row: ProcessDeploymentRow;
                Insert: ProcessDeploymentInsert;
                Update: ProcessDeploymentUpdate;
                Relationships: [];
            };
            company_currency_settings: {
                Row: CompanyCurrencySettingsRow;
                Insert: CompanyCurrencySettingsInsert;
                Update: CompanyCurrencySettingsUpdate;
                Relationships: [];
            };
            compliance_rules: {
            ...
            project_process_instances: {
                Row: ProjectProcessInstanceRow;
                Insert: ProjectProcessInstanceInsert;
                Update: ProjectProcessInstanceUpdate;
                Relationships: [];
            };
            liquidity_event_instances: {
                Row: LiquidityEventInstanceRow;
                Insert: LiquidityEventInstanceInsert;
                Update: LiquidityEventInstanceUpdate;
                Relationships: [];
            };
            bank_upload_files: {
                Row: BankUploadFileRow;
                Insert: BankUploadFileInsert;
                Update: BankUploadFileUpdate;
                Relationships: [];
            };
            bank_transactions: {
            ...
            interface_execution_log: {
                Row: InterfaceExecutionLogRow;
                Insert: InterfaceExecutionLogInsert;
                Update: InterfaceExecutionLogUpdate;
                Relationships: [];
            };
            holding_subscriptions: {
                Row: HoldingSubscriptionRow;
                Insert: HoldingSubscriptionInsert;
                Update: HoldingSubscriptionUpdate;
                Relationships: [];
            };
            holding_onboarding: {
                Row: HoldingOnboardingRow;
                Insert: HoldingOnboardingInsert;
                Update: HoldingOnboardingUpdate;
                Relationships: [];
            };
            user_invitations: {
            ...
            platform_metrics: {
                ...
                Insert: PlatformMetricInsert;
                Update: PlatformMetricUpdate;
                Relationships: [];
            };
            help_snippets: {
                Row: HelpSnippetRow;
                Insert: HelpSnippetInsert;
                Update: HelpSnippetUpdate;
                Relationships: [];
            };
            user_tour_progress: {
                Row: UserTourProgressRow;
                Insert: UserTourProgressInsert;
                Update: UserTourProgressUpdate;
                Relationships: [];
            };
            help_feedback: {
                Row: HelpFeedbackRow;
                Insert: HelpFeedbackInsert;
                Update: HelpFeedbackUpdate;
                Relationships: [];
            };
            company_feature_flags: {
                Row: CompanyFeatureFlagsRow;
                Insert: CompanyFeatureFlagsInsert;
                Update: CompanyFeatureFlagsUpdate;
                Relationships: [];
            };
            suppliers: {
                Row: SupplierRow;
            ...
            invoices_incoming: {
                Row: InvoiceIncomingRow;
                Insert: InvoiceIncomingInsert;
                Update: InvoiceIncomingUpdate;
                Relationships: [];
            };
            invoice_line_items: {
            ...
            payment_run_items: {
                Row: PaymentRunItemRow;
                Insert: Record<string, unknown>;
                Update: Record<string, unknown>;
                Relationships: [];
            };
            cashout_residual_decisions: {
                Row: CashoutResidualDecisionRow;
                Insert: Record<string, unknown>;
                Update: Record<string, unknown>;
                Relationships: [];
            };
            company_banking_config: {
                Row: CompanyBankingConfigRow;
                Insert: Record<string, unknown>;
                Update: Record<string, unknown>;
                Relationships: [];
            };
            process_kpi_definitions: {
                Row: ProcessKpiDefinitionRow;
                Insert: ProcessKpiDefinitionInsert;
                Update: ProcessKpiDefinitionUpdate;
                Relationships: [];
            };
            process_kpi_values: {
                Row: ProcessKpiValueRow;
                Insert: ProcessKpiValueInsert;
                Update: Record<string, unknown>;
                Relationships: [];
            };
            process_phases: {
                Row: ProcessPhaseRow;
                Insert: ProcessPhaseInsert;
                Update: ProcessPhaseUpdate;
                Relationships: [];
            };
        };
