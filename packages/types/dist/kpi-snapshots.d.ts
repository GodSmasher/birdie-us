export declare const KPI_SNAPSHOT_TYPES: {
    readonly SETTER_DAILY: "setter_daily";
    readonly SETTER_WEEKLY: "setter_weekly";
    readonly BERATER_DAILY: "berater_daily";
    readonly BERATER_WEEKLY: "berater_weekly";
    readonly LEADS_DAILY: "leads_daily";
    readonly FINANCE_MONTHLY: "finance_monthly";
    readonly PROJECTS_DAILY: "projects_daily";
    readonly TENANT_DAILY_SUMMARY: "tenant_daily_summary";
};
...
//# sourceMappingURL=kpi-snapshots.d.ts.map